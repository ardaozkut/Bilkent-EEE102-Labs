...
entity Address_Generator is
    Port ( 	CLK25,enable : in  STD_LOGIC;								-- 25 MHz clock and enable signal respectively
            ...
            vsync        : in  STD_LOGIC;
				address 		 : out STD_LOGIC_VECTOR (18 downto 0));	-- generated address

end Address_Generator;

architecture Behavioral of Address_Generator is
   signal val: STD_LOGIC_VECTOR(address'range):= (others => '0');		-- intermediate signal

begin
	address <= val;																		-- generated address


	process(CLK25)
		begin
         if rising_edge(CLK25) then
            if (enable='1') then													-- if enable = 0, address generation is stopped
